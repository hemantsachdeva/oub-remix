...
async def gbun(event):
    ...
    await event.edit("**GBan Loading in process. Wanna leave? ☠️**")
    asyncio.sleep(3.5)
    ...
    if event.reply_to_msg_id:
        ...
        if idd == 810997061:
            await reply_message.reply("`Wait a second, This is my master!`\n**How dare you threaten to ban my master nigger!**\n\n__Your account has been hacked! Pay 6969$ to my master__ [HeManTSacHDevA](tg://user?id=810997061) __to release your account__😏")
        else:
            jnl=("`Warning!!`"
                  "[{}](tg://user?id={})"
...
=======
        mention = (f"Warning!! User 𝙂𝘽𝘼𝙉𝙉𝙀𝘿 By {DEFAULTUSER} \nReason: No Reason Given. ")
>>>>>>> 6de0a7d8aaf162ab7157995ba669e93bac5d33ce
